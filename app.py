...
def predict():
    ...
    # data = []
    loaded_model.input['harga'] = (((100 / 7) * float(q3)) * 0.5) + (((100 / 7) * float(q4)) * 0.5)
    loaded_model.input['cuaca'] = (((100 / 7) * float(q10)) * 0.5) + (((100 / 7) * float(q11)) * 0.5)
    ...
    return render_template('index.html', d1=d1, d2=d2, d3=d3, d4=d4, d5=d5, q3=q3, q4=q4, q10=q10, q11=q11, q12=12, output=kategori_penjualan_loaded)
